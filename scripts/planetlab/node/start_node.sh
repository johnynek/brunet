...
/home/$PLAB_ACCOUNT/node/basicnode /home/$PLAB_ACCOUNT/node/node.config.$PLAB_ACCOUNT 2>&1 | /home/$PLAB_ACCOUNT/node/cronolog --period="1 day" /home/$PLAB_ACCOUNT/node/node.log.%y%m%d.txt &
