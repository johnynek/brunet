...
namespace Brunet.Graph {
  public class GraphNode {
    ...
    public AHRoutingAlgorithm Router { get { return _router; } } 
    protected AHRoutingAlgorithm _router;
    ...
    {
      _router = new GreedyRouting(Address, ConnectionTable.GetConnections(ConnectionType.Structured));
    }
  }
}
