  ...
  public class CMPTester {
    ...
    public void Test()
    {
      ...
      for(int i = 5001; i < 5010; i++) {
        neighbors.Add(NodeInfo.CreateInstance(new DirectionalAddress(DirectionalAddress.Direction.Left),
