...
namespace Brunet.Dht {
  public class EntryFactory {
	...
	Directory.CreateDirectory("data" + OS.OSDir() + _node.Address.ToString().Substring(12));
#if DHT_DEBUG	
	...
	return new Entry(key, password, create_time, end_time, data, idx);
      ...
      if (_media == Media.Disk) {
	return new DiskEntry("data" + OS.OSDir() + _node.Address.ToString().Substring(12), key, password, create_time, end_time, data, idx);
      } 
