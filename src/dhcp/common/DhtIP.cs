...
namespace Ipop {
  public class DhtIP {
	...
	return;
      ...
      BlockingQueue [] queues = _dht.DeleteF(
					     Encoding.UTF8.GetBytes("dhcp:ipop_namespace:" + ":" + ipop_namespace + 
								    ":ip:" + ip),
					     password);
    ...
    private static bool _using_dht;
    ...
    public static bool GetIP(FDht _dht, string ipop_namespace, string ip, int leasetime, byte [] brunet_id, 
			     string password, out string new_password) {
